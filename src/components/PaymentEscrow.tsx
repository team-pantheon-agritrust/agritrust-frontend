        ...
        >
          ...
          >
            <p className="text-[13px] text-white/55 leading-[1.5]">
              Funds are securely held until delivery is verified. Payment will
              be released to the farmer automatically upon confirmation.
            </p>
          </div>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-[14px] p-4 flex gap-3 items-start mb-6">
          ...
          <div>
            ...
            <p className="text-[12px] text-amber-700 leading-[1.5]">
              After transferring, the farmer will be notified and delivery
              tracking begins. Use the transaction reference above to verify
              delivery.
            </p>
          </div>
        </div>
