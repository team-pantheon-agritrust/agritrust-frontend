  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', color: 'rgba(255,255,255,0.25)', textTransform: 'uppercase', padding: '4px 12px', marginBottom: 4 }}>
          Menu
        </div>
        {items.map(item => (
          <button
          ...
          >
            <span style={{ opacity: current === item.id ? 1 : 0.5, display: 'flex' }}>
              {item.icon}
            </span>
            {item.label}
          </button>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', margin: '12px 0 12px', paddingTop: 12 }}>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', color: 'rgba(255,255,255,0.25)', textTransform: 'uppercase', padding: '0 12px', marginBottom: 4 }}>
            Switch
          </div>
          <button
...
function SwitchIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M3 5h10M11 3l2 2-2 2M13 11H3M5 9l-2 2 2 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
function HomeIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <path d="M6 14V10h4v4" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  )
}
