  ...
  return (
    <div>
      ...
      <div className="max-w-[680px] mx-auto p-10 px-8">
        ...
        {state === "scanning" && (
          <ScanningState grain={selectedGrain} imagePreview={imagePreview} />
        )}
        ...
        {state !== "scanning" && (
          <div className="flex flex-col gap-5">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 mt-2 flex-wrap">
                    {["JPG", "PNG", "HEIC", "WEBP"].map((f) => (
                      <span
                        key={f}
                        className="px-[9px] py-[2px] bg-white border border-slate-200 rounded-full text-[10px] font-semibold text-slate-400"
                      >
                        {f}
                      </span>
                    ))}
            ...
            {/* Tips */}
            <div className="bg-white border border-slate-900/[0.06] rounded-[20px] shadow-sm p-5">
              <div className="text-[13px] font-semibold text-slate-900 mb-[14px]">
              ...
              <div className="flex flex-col gap-[10px]">
                {[
                  ...
                  {
                    icon: "🧹",
                    tip: "Use a clean, neutral-coloured background",
                  },
                ].map((t) => (
...
function ScanningState({
  ...
  return (
    <div className="flex flex-col gap-5">
      <div
        className="rounded-[28px] overflow-hidden relative h-[280px] flex items-center justify-center"
      ...
      >
        {imagePreview ? (
          ...
          <div
            className="absolute inset-0 flex items-center justify-center text-[80px] opacity-60"
            style={{
