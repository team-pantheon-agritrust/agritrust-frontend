      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto px-4 sm:px-8 py-16 sm:py-20 relative z-[1] w-full">
        <div className="animate-fade-up text-center lg:text-left">
          ...
          <p className="text-[17px] leading-[1.65] text-slate-500 mb-9 max-w-[480px] mx-auto lg:mx-0">
            AgriTrust uses computer vision to grade grain quality, set fair
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-slate-900/[0.06] border border-slate-900/[0.06] rounded-[20px] overflow-hidden mb-5">
            {[
              ...
              <div key={s.label} className="px-6 py-5 bg-white">
                <div className="text-[26px] font-extrabold tracking-[-0.04em] text-slate-900 mb-[3px]">
                  {s.value}
                </div>
          ...
          <div className="flex items-center justify-center lg:justify-start gap-5 flex-wrap">
            {[
              ...
              <div
                key={t}
                className="flex items-center gap-[7px] text-[13px] font-medium text-slate-500"
              >
                <CheckIcon />
                {t}
              </div>
        ...
        <div className="relative flex items-center justify-center">
          <div className="w-full max-w-[440px] bg-white border border-slate-900/[0.06] rounded-[28px] shadow-2xl overflow-hidden animate-float">
            <div className="bg-slate-900 px-5 py-[18px] flex items-center gap-[10px]">
              ...
              <span className="text-xs font-semibold text-white/40 tracking-[0.05em] ml-1">
                GRAIN ANALYSIS
              </span>
            </div>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    "radial-gradient(circle at 20% 50%,rgba(237,228,213,0.3) 0%,transparent 25%),radial-gradient(circle at 80% 20%,rgba(237,228,213,0.2) 0%,transparent 25%),radial-gradient(circle at 60% 80%,rgba(237,228,213,0.25) 0%,transparent 20%)",
                }}
              />
              <div
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-[52px] h-[52px] rounded-full bg-emerald-50 border-2 border-[#A7F3D0] flex items-center justify-center text-[22px] font-extrabold text-emerald-600">
                    A
                  </div>
                  <div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-[22px] font-bold text-slate-900 tracking-[-0.03em]">
                    ₦87,500
                  </div>
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={m.label} className="flex items-center gap-[10px]">
                    <div className="text-xs text-slate-400 font-medium w-[70px] shrink-0">
                      {m.label}
                    </div>
                    ...
                    <div className="text-xs font-semibold text-slate-900 min-w-[32px] text-right">
                      {m.val}
                    </div>
                  </div>
                ))}
          ...
          <div className="hidden md:flex absolute -bottom-2 -left-10 bg-white border border-slate-900/[0.06] rounded-[14px] shadow-xl px-4 py-3 items-center gap-[10px] text-[13px] font-medium text-slate-900 whitespace-nowrap animate-float-a">
            <div className="w-8 h-8 rounded-full bg-emerald-50 border border-[#A7F3D0] flex items-center justify-center text-base">
              ✓
            </div>
            <div>
      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <div className="text-center max-w-[600px] mx-auto">
          ...
          <h2 className="text-[clamp(28px,4vw,42px)] font-extrabold tracking-[-0.035em] text-slate-900 leading-[1.15] mb-4">
            Everything grain trading needs,
            <br />
            in one platform
          </h2>
          <p className="text-base text-slate-500 leading-[1.7] mx-auto">
            From farm to payment, AgriTrust handles every step with AI precision
            and financial-grade security.
          </p>
        </div>
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-12 mt-[48px] sm:mt-[60px]">
          ...
          {steps.map((s, i) => (
            <div key={s.n} className="text-center">
              ...
              <h3 className="text-base font-bold text-slate-900 mb-2 tracking-[-0.02em]">
                {s.title}
              </h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.06] border border-white/[0.06] rounded-[20px] overflow-hidden">
          {stats.map((s) => (
            <div key={s.label} className="px-7 py-9 bg-slate-900 text-center">
              <div className="text-[40px] font-extrabold tracking-[-0.04em] text-white mb-[6px]">
                {s.value}
              </div>
...
function TestimonialsSection() {
  const testimonials = [
    {
      text: "AgriTrust changed everything. Before, buyers would claim my maize was low quality and pay almost nothing. Now the AI grades it and I can't be cheated.",
      name: "Aminu Yusuf",
    ...
    {
      text: "We process 200+ transactions a month through AgriTrust. The aggregator tools are exceptional — batch orders, consolidated shipping, real-time tracking.",
      name: "Ibrahim Musa",
      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-[48px] sm:mt-[60px]">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="p-7 bg-cream border border-sand rounded-[20px]"
            >
              ...
              <p className="text-sm leading-[1.75] text-slate-600 mb-5 italic">
                "{t.text}"
              </p>
    ...
    <section className="py-[80px] sm:py-[100px] bg-slate-900 text-center relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto px-6 relative">
        <h2 className="text-[clamp(32px,4vw,48px)] font-extrabold tracking-[-0.04em] text-white mb-4">
          Ready to trade grain
          <br />
          the right way?
        </h2>
        <p className="text-[17px] text-white/50 mb-10 max-w-[480px] mx-auto">
          Join 12,000+ farmers and 800+ buyers already using AgriTrust to trade
          smarter, safer, and fairer.
        </p>
      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <div className="grid gap-10 lg:gap-12 mb-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          {[
            ...
            <div key={col.title}>
              <div className="text-xs font-bold tracking-[0.07em] uppercase text-slate-400 mb-4">
                {col.title}
              </div>
              <div className="flex flex-col gap-[10px]">
                {col.links.map((l) => (
                  <span
                    key={l}
                    className="text-sm text-slate-500 cursor-pointer transition-colors duration-[220ms] hover:text-slate-900"
                  >
                    {l}
                  </span>
                ))}
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="text-[13px] text-slate-400">
            © 2025 AgriTrust Technologies Ltd. All rights reserved.
          </div>
...
function ShieldIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path
        d="M10 2L3 5v5c0 4.4 3 8.3 7 9 4-0.7 7-4.6 7-9V5l-7-3z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
function NetworkIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <path
        d="M5.5 6l3 3M14.5 6l-3 3M5.5 14l3-3M14.5 14l-3-3"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
